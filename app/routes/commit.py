...
async def commit(req: CommitRequest):
    ...
    async with httpx.AsyncClient(timeout=30.0) as client:
        ...
        course_cells = [
            ...
            {"column": "c-scopeNotes",  "value": cl.get("scope_notes", "")},
            {"column": "c-modality",    "value": cl.get("modality", "")},
            {"column": "c-asmtRat",     "value": cl.get("assessment_rationale", "")},
            {"column": "c-evidence",    "value": cl.get("evidence", "")},
            {"column": "c-lrStrategy",  "value": cl.get("lr_strategy", "")},
            {"column": "c-toolsTech",   "value": cl.get("tools_tech", "")},
        ]
